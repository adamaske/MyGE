...
EVRInitError ControllerDriver::Activate(uint32_t unObjectId)
{
	...
	VRProperties()->SetStringProperty(props, Prop_InputProfilePath_String, "{oculus}/input/legacy_bindings_rift.json"); //tell OpenVR where to get your driver's Input Profile
