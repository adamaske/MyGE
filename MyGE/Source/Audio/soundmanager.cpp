...
SoundSource* SoundManager::createSource(std::string name, glm::vec3 pos, std::string filePath, bool loop, float gain)
{
...
void SoundManager::updateListener(glm::vec3 pos, glm::vec3 vel, glm::vec3 dir, glm::vec3 up)
{
    //Have to convert glm::vec3 to ALfloats
    ALfloat posVec[3];
    ALfloat velVec[3];
    ALfloat headVec[6];
    posVec[0] = pos.x;
